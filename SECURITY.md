...
Replace this section with the supported versions for `artifactmap`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `artifactmap` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in artifactmap.
